(function() {
  ...
  // con panel avanzado de selección de fondo y contorno del botón interno, incluyendo forma de borde.
  ...
  function openOutlinePanel(block, innerBtn) {
    ...
    function applyOutline() {
      ...
      // aplicar forma de borde siempre despues
    ...
    cb.addEventListener('change', () => {
      ...
      dirContainer.style.display = active && gradientToggle.classList.contains('active') ? 'flex' : 'none';
